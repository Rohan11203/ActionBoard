        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <a
                href="/auth/register"
                className="ml-4 px-4 py-2 rounded-md bg-blue-600 text-white font-medium hover:bg-blue-700"
              >
                Sign Up
              </a>
              <a
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="md:w-1/2 mb-12 md:mb-0">
              ...
              <p className="mt-4 text-base text-blue-800 sm:text-lg md:text-xl">
                Streamline your workflow, collaborate seamlessly, and never miss
                a deadline with Action Aboard.
              </p>
              <div className="mt-8">
                <a
                  href="/auth/register"
                ...
                <a
                  href="#"
                  className="ml-4 inline-flex items-center px-6 py-3 border border-blue-300 text-base font-medium rounded-md text-blue-700 bg-white hover:bg-blue-50"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-lg font-medium text-blue-800">
                Action Aboard
              </span>
            </div>
            <div className="mt-4 md:mt-0">
              <p className="text-sm text-gray-500">
                © 2025 Action Aboard. All rights reserved.
              </p>
            </div>
          </div>
        </div>
